...
Olá! Sou o **Miguel Moura Mendes**, estudante de **Ciência da Computação** no **Instituto Federal de Brasília (IFB)**. 

Sou entusiasta do desenvolvimento de software, algoritmos e automação de processos. Tenho foco em construir soluções eficientes que integram bancos de dados, linguagens de programação e ferramentas modernas de automação.

- 🎓 **Curso:** Ciência da Computação (4º Semestre) — IFB
- 🎯 **Interesses:** Desenvolvimento de Software, Estrutura de Dados & Algoritmos, Computação Gráfica e Automação de Workflows
- 💼 **Em busca de:** Oportunidades de estágio/trabalho em Ciência da Computação e Desenvolvimento de Software
